...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateKeyword func(childComplexity int, input NewKeyword) int
...
type MutationResolver interface {
	CreateKeyword(ctx context.Context, input NewKeyword) (models.Keyword, error)
	CreateTag(ctx context.Context, input NewTag) (models.Tag, error)
}
...
func field_Mutation_createKeyword_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 NewKeyword
	if tmp, ok := rawArgs["input"]; ok {
		var err error
		arg0, err = UnmarshalNewKeyword(tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Keyword.user":
		if e.complexity.Keyword.User == nil {
			break
		}

		return e.complexity.Keyword.User(childComplexity), true

	case "Mutation.createKeyword":
		if e.complexity.Mutation.CreateKeyword == nil {
			break
		}

		args, err := field_Mutation_createKeyword_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.CreateKeyword(childComplexity, args["input"].(NewKeyword)), true
...
func (ec *executionContext) _Keyword(ctx context.Context, sel ast.SelectionSet, obj *models.Keyword) graphql.Marshaler {
	fields := graphql.CollectFields(ctx, sel, keywordImplementors)
	...
	for i, field := range fields {
		...
		case "user":
			out.Values[i] = ec._Keyword_user(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		default:
...
// nolint: vetshadow
func (ec *executionContext) _Keyword_id(ctx context.Context, field graphql.CollectedField, obj *models.Keyword) graphql.Marshaler {
...
// nolint: vetshadow
func (ec *executionContext) _Keyword_text(ctx context.Context, field graphql.CollectedField, obj *models.Keyword) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Keyword",
...
// nolint: vetshadow
func (ec *executionContext) _Keyword_user(ctx context.Context, field graphql.CollectedField, obj *models.Keyword) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Keyword",
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "createKeyword":
			out.Values[i] = ec._Mutation_createKeyword(ctx, field)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "createTag":
...
// nolint: vetshadow
func (ec *executionContext) _Mutation_createKeyword(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateKeyword(rctx, args["input"].(NewKeyword))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
	...
	return ec._Keyword(ctx, field.Selections, &res)
}
	...
	for idx1 := range res {
		...
		f := func(idx1 int) {
			...
			arr1[idx1] = func() graphql.Marshaler {
				...
				return ec._Keyword(ctx, field.Selections, &res[idx1])
			}()
		}
		if isLen1 {
			f(idx1)
...
// nolint: vetshadow
func (ec *executionContext) _Tag_text(ctx context.Context, field graphql.CollectedField, obj *models.Tag) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Tag",
...
// nolint: vetshadow
func (ec *executionContext) _Tag_user(ctx context.Context, field graphql.CollectedField, obj *models.Tag) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Tag",
...
func UnmarshalNewKeyword(v interface{}) (NewKeyword, error) {
	var it NewKeyword
...
var parsedSchema = gqlparser.MustLoadSchema(
	&ast.Source{Name: "schema.graphql", Input: `type Keyword {
  id: ID!
  text: String!
  user: User!
}
